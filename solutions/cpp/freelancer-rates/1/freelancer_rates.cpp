...
int monthly_rate(double hourly_rate, double discount) {
    ...
    double monthly_after_discount = apply_discount(monthly_before_discount, discount);
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    double discounted_days = apply_discount(daily_rate(hourly_rate), discount);
    return std::floor(budget / discounted_days);
}
